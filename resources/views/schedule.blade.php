          ...
          @foreach($workDays as $key => $workday)
            <tr>
              ...
              <th>
                <div class="row">
                  <div class="col">
                    <select class="form-control" name="moorning_start[]">
                      @for($i=5; $i<=11; $i++)
                        <option value="{{ ($i<10 ? 0 : ''). $i }}:00"
                          @if($i.':00 AM' == $workday->moorning_start) selected @endif>
                          {{ $i }}:00 AM
                        </option>
                        <option value="{{ ($i<10 ? 0 : ''). $i }}:30"
                          @if($i.':30 AM' == $workday->moorning_start) selected @endif>
                          {{ $i }}:30 AM
                        </option>
                      @endfor
                    </select>
                  ...
                  <div class="col">
                    <select class="form-control" name="moorning_end[]">
                      @for($i=5; $i<=11; $i++)
                        <option value="{{ ($i<10 ? 0 : ''). $i }}:00"
                          @if($i.':00 AM' == $workday->moorning_end) selected @endif>
                          {{ $i }}:00 AM
                        </option>
                        <option value="{{ ($i<10 ? 0 : ''). $i }}:30"
                          @if($i.':30 AM' == $workday->moorning_end) selected @endif>
                          {{ $i }}:30 AM
                        </option>
                      @endfor
                    </select>
